...
public final class MCCLoggerPlugin: PluginType {
    ...
    public func willSend(_ request: RequestType, target: TargetType) {
        guard MCCNetworkConfig.shared.isRequestLoggingEnabled, let req = request.request else { return }
        startTime[req.hashValue] = Date()
    }
    ///
    public func didReceive(_ result: Result<Response, MoyaError>, target: TargetType) {
        guard MCCNetworkConfig.shared.isRequestLoggingEnabled else { return }
        switch result {
